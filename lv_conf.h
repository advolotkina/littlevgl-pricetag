...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <time.h>          /*Just include something*/
uint32_t custom_tick_get(void);
#define LV_TICK_CUSTOM_SYS_TIME_EXPR custom_tick_get()     /*Expression evaluating to current systime in ms*/
